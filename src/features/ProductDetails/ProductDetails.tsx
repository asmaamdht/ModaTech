  ...
  return (
    <SafeAreaProvider>
      <View style={styles.mainContainer}>
        ...
        <View style={{ top: hp("-5") }}>
          <StyledText title={prod.title} style={styles.prodTitle} />
          <StarRatingDisplay
            rating={4.5}
            starSize={20}
          ...
          <View style={styles.container}>
            <View style={styles.container}>
              <StyledText title={prod.price} style={styles.price} />
              <StyledText title={prod.sale} style={styles.sale} />
            </View>
            <StyledText title={t("avaiableProd")} style={styles.price} />
          </View>
          <StyledText style={styles.desc} title={prod.description} />
        </View>
        <StyledButton
          value={"Add to Cart  |  "}
